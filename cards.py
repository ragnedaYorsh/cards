...
new_player = Player("Ragneda")
print(new_player)
# Player Ragneda has 0 cards.

new_player.add_cards(mycard)
print(new_player)
# Player Ragneda has 1 cards.
...
print(new_player)
# Player Ragneda has 4 cards.

new_player.remove_one()
print(new_player)
# Player Ragneda has 3 cards.
...
for x in range(26):  # 26 because Deck() has 52 cards.
